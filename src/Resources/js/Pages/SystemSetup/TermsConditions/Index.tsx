...
export default function TermsConditions() {
    ...
    const validateForm = () => {
        ...
        if (!formSettings.content.trim()) {
            newErrors.content = t('Terms and conditions content is required');
        }
    ...
    const saveSettings = () => {
        ...
        router.post(route('support-ticket.settings.terms.update'), {
                        ...
                        <CardContent className="p-6">
                            ...
                            <div className="space-y-6">
                                ...
                                <div className="space-y-3">
                                    <Label htmlFor="content">{t('Terms & Conditions Content')} <span className="text-red-500">*</span></Label>
                                    <div className={errors.content ? 'border border-red-500 rounded-md' : ''}>
                                        <RichTextEditor
                                            content={formSettings.content}
                                            onChange={handleContentChange}
                                            placeholder={t('Enter terms and conditions content...')}
                                        />
                                    </div>
